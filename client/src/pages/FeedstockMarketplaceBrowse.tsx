...
const MOCK_FEEDSTOCK_TYPES: FeedstockType[] = [
  { id: '1', name: 'Biomass', icon: 'Leaf' },
  { id: '2', name: 'Algae', icon: 'Water' },
  { id: '3', name: 'Waste Oil', icon: 'Oil' },
  { id: '4', name: 'Sugars', icon: 'Sugar' },
  { id: '5', name: 'Starch', icon: 'Grain' },
  { id: '6', name: 'Lignocellulosic', icon: 'Wood' },
  { id: '7', name: 'Animal Fats', icon: 'Meat' },
  { id: '8', name: 'Municipal Waste', icon: 'Trash' },
  { id: '9', name: 'Agricultural Residues', icon: 'Farm' },
  { id: '10', name: 'Forest Residues', icon: 'Tree' },
  { id: '11', name: 'Industrial Byproducts', icon: 'Factory' },
  { id: '12', name: 'Other', icon: 'Question' },
];
...
const MOCK_FEEDSTOCKS: Feedstock[] = [
  ...
  {
    id: 'f4',
    name: 'Palm Oil Mill Effluent',
    type: MOCK_FEEDSTOCK_TYPES[1],
    location: 'Kuala Lumpur, Malaysia',
    bankability: { status: 'Risk', score: 45 },
    quantity: 2500,
    unit: 'm³',
    supplierRating: 2.5,
    price: 15,
