    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto py-12">
        <div className="mx-auto max-w-6xl">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl text-[#0F3A5C]">Locate Your Property</CardTitle>
              <CardDescription>
                Click on the map or search for your property address. We'll use this to identify your agricultural zone and climate region.
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="relative h-[500px] rounded-lg border-2 border-dashed border-gray-300 bg-gray-100">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-lg font-medium text-gray-700">Interactive Map Loading...</p>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                    <div className="mb-2 flex items-center gap-2">
                      ...
                      <span className="font-medium text-green-900">Sugarcane Belt</span>
                    </div>
                    <p className="text-sm text-green-700">QLD coastal regions</p>
                  </div>

                  <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4">
                    <div className="mb-2 flex items-center gap-2">
                      <div className="h-4 w-4 rounded-full bg-yellow-500"></div>
                      <span className="font-medium text-yellow-900">Grain Belt</span>
                    </div>
                  ...
                  <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                    <div className="mb-2 flex items-center gap-2">
                      ...
                      <span className="font-medium text-blue-900">Forestry Zones</span>
                    </div>
