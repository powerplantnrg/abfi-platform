  ...
  return (
    <div className="rounded-3xl p-10" style={{ 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {/* Feedstock Type */}
        <div>
          <label className="block text-sm font-semibold mb-2 uppercase tracking-wide" style={{ color: '#6b7c6b' }}>
            Feedstock Type
          </label>
          <select
            value={feedstockType}
        ...
        <div>
          ...
          <div className="relative">
            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-lg font-semibold" style={{ color: '#6b7c6b' }}>
              $
            </span>
            <input
              type="number"
      ...
      <div className="rounded-2xl p-8 mb-6" style={{ 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="text-center">
            <div className="text-xs font-bold uppercase tracking-wider mb-2" style={{ color: '#6b7c6b' }}>
          ...
          <div className="flex items-center justify-center">
            <div className="text-4xl" style={{ color: '#2d5a27' }}>→</div>
          </div>
        ...
        <div className="rounded-xl p-6 text-center" style={{ 
          ...
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <div className="text-xs font-bold uppercase tracking-wider" style={{ color: '#6b7c6b' }}>
              Your Annual Gain
            </div>
          </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="rounded-xl p-4 text-center" style={{ background: '#f5f0e6' }}>
          <div className="text-xs font-semibold uppercase tracking-wide mb-1" style={{ color: '#6b7c6b' }}>
            Per Tonne Gain
          </div>
      ...
      {/* Disclaimer */}
      <div className="text-center">
        <p style={{ fontSize: '12px', color: '#6b7c6b', fontStyle: 'italic', lineHeight: 1.5 }}>
          * Calculations based on current regional market averages. Actual prices vary by location, quality, delivery terms, and market conditions. 
          BioFeed AU prices shown are platform averages for verified, delivered feedstock.
        </p>
      </div>
